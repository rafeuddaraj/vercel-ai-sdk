...
import { pokenmonUiSchema } from "../api/structured-array/schema";


export default function page() {
    const { object, submit, error, isLoading, stop } = useObject({ api: "/api/structured-array", schema: pokenmonUiSchema })
